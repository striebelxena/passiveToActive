...
def evaluate_sentence_results(goldstandard, transformed):
    ...
    P, R, F1 = score(
        transformed_bert, goldstandard_bert, lang="en", model_type="bert-base-uncased"
    )
    ...
    candidates = [
        "Where applicable, the identification number of the notified body responsible for the conformity assessment procedures set out in Article 52 shall follow the CE marking."
    ]

    # Der erwartete Goldstandard-Satz
    references = [
        "The identification number of the notified body responsible for the conformity assessment procedures set out in Article 52 shall follow the CE marking where applicable."
    ]
